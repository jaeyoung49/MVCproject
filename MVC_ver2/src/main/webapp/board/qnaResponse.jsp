			...
			$(document).ready(function(){
				$.ajax({
					...
					success : function(data){
						alert("등록되었습니다");
						location.href="qnaDetailNoHit.do?articleNo="+data;
					}
				});
			});
		}
...
<input type="hidden" name="articleNo" value=${requestScope.qnaVO.articleNo }>
<input type="hidden" name="responseGroup" value=${requestScope.qnaVO.responseGroup }>
<input type="hidden" name="responseOrder" value=${requestScope.qnaVO.responseOrder+1 }>
<input type="hidden" name="responseStep" value=${requestScope.qnaVO.responseStep+1 }>
</form>